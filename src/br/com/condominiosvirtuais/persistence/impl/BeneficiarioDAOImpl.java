...
public class BeneficiarioDAOImpl implements Serializable, BeneficiarioDAO {
	...
	public void salvar(Beneficiario beneficiario) throws SQLException, BusinessException, Exception {
		...
		try {
			...
			SQLUtil.setValorPpreparedStatement(statement, 7, beneficiario.getTipoDocumento(), java.sql.Types.INTEGER);
			statement.execute();
	...
	public List<Beneficiario> buscarPorIdCondominio(Integer idCondominio) throws SQLException, BusinessException, Exception {
		...
		try {
			...
			while(resultSet.next()){
				...
				beneficiario.setTipoDocumento((Integer) SQLUtil.getValorResultSet(resultSet, TIPO_DOCUMENTO, java.sql.Types.INTEGER));
	...
	public void atualizar(Beneficiario beneficiario) throws SQLException, BusinessException, Exception {
		...
		try {			
			...
			SQLUtil.setValorPpreparedStatement(statement, 6, beneficiario.getNomeFantasia(), java.sql.Types.VARCHAR);
			SQLUtil.setValorPpreparedStatement(statement, 7, beneficiario.getTipoDocumento(), java.sql.Types.INTEGER);
			SQLUtil.setValorPpreparedStatement(statement, 8, beneficiario.getId(), java.sql.Types.INTEGER);			
