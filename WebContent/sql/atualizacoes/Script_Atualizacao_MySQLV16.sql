...
ALTER TABLE GRUPO_USUARIO ADD COLUMN TIPO_USUARIO INTEGER NOT NULL DEFAULT 0;
...
(DEFAULT,'formEditaDespesa.idBotaoExcluirDespesa','formEditaDespesa.idBotaoExcluirDespesaDescricao','idBotaoExcluirDespesa',60,null,'componente.tipo.0'),
...
(DEFAULT,4,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formEditaDespesa.xhtml')),
(DEFAULT,4,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formEditaReceita.xhtml')),
...
(DEFAULT,1,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formCadastroCondominio.xhtml')),
(DEFAULT,1,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formFaleComSindico.xhtml')),
(DEFAULT,1,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formAssociarGrupoUsuarioCondominio.xhtml')),
(DEFAULT,1,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formAssociarGrupoUsuario.xhtml')),
...
(DEFAULT,1,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formCadastroSindicoProfissional.xhtml')),
(DEFAULT,1,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formListaSindicoProfissional.xhtml')),
(DEFAULT,1,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formEditaSindicoProfissional.xhtml')),
...
(DEFAULT,3,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formEscreverMensagem.xhtml'),(SELECT ID FROM ABA WHERE NOME = 'formEscreverMensagem.idTabMensagemFuncionarios')),
...
(DEFAULT,1,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formEditaReceita.xhtml'),(SELECT ID FROM COMPONENTE WHERE NOME = 'formEditaReceita.idBotaoExcluirReceita')),
(DEFAULT,3,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formEditaReceita.xhtml'),(SELECT ID FROM COMPONENTE WHERE NOME = 'formEditaReceita.idBotaoExcluirReceita')),
(DEFAULT,4,(SELECT ID FROM TELA WHERE NOME_ARQUIVO = 'formEditaReceita.xhtml'),(SELECT ID FROM COMPONENTE WHERE NOME = 'formEditaReceita.idBotaoExcluirReceita')),
