...
ALTER TABLE RECEITA ADD COLUMN ID_BANCO INTEGER NOT NULL DEFAULT 1 AFTER ID_MEIO_PAGAMENTO;

ALTER TABLE RECEITA ADD CONSTRAINT FK_RECEITA_ID_BANCO_BANCO_ID FOREIGN KEY (ID_BANCO) REFERENCES BANCO(ID);

ALTER TABLE DESPESA ADD COLUMN ID_BANCO INTEGER NOT NULL DEFAULT 1 AFTER ID_MEIO_PAGAMENTO;
